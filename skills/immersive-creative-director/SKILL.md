...
1. Before substantive questions, concepts, critique, or planning, read every mandatory core file completely to EOF in this order: [orchestration.md](references/orchestration.md), [preferences.md](references/preferences.md), [experience-contract.md](references/experience-contract.md), [evidence-library.md](references/evidence-library.md), [visual-reference-manifest.md](references/visual-reference-manifest.md), [process-reference-manifest.md](references/process-reference-manifest.md), [reference-corpus.md](references/reference-corpus.md), [doctrine.md](references/doctrine.md), [motion-vocabulary.md](references/motion-vocabulary.md), [production.md](references/production.md), [previsualization.md](references/previsualization.md), [quality-gates.md](references/quality-gates.md), and [evolving-the-library.md](references/evolving-the-library.md). A search hit, excerpt, prior memory, summary, or earlier invocation is not the current invocation's read.
